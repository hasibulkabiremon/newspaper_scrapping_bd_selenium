...
newspaper_url = sys.argv[1]
category_xpath = sys.argv[2]
headline_xpath = sys.argv[3]
news_author_xpath = sys.argv[4]
news_time_xpath = sys.argv[5]
news_text_xpath = sys.argv[6]
...
def main():
    ...
    category_driver.get(newspaper_url)

    category_elements = category_driver.find_elements(By.XPATH, category_xpath)
...
def headline(headlineLink):
    ...
    print(headlineLink)
    headline_element = headline_driver.find_elements(By.XPATH, headline_xpath)
...
def news_Details(newsLink):
    ...
    news_author = news_driver.find_element(By.XPATH, news_author_xpath).text
    news_time = news_driver.find_element(By.XPATH,news_time_xpath).text
    news_text = news_driver.find_element(By.XPATH,news_text_xpath).text
